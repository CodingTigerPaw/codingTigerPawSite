...
const SkillsSection = () => {
    return(
        <div id="skillsSection" className="container bg-gray-600 mt-8 md:mt-0 m-auto h-screen flex flex-col md:flex-row">
            <div className=" md:w-1/2 md:pt-32 ">
                ...
                <img src={Tiger} alt="not working..." className=" hidden md:inline w-5/6 md:h-auto ml-auto mr-auto md:w-full mt-4 md:mt-0 imgShapeLeft  border-t-4 border-b-4 border-yellow-300" />
            </div>
